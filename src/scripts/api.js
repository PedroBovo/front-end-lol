const routes= {
  champions:"http://campeoesleagueoflegends.sa-east-1.elasticbeanstalk.com/champions",
  ask: "http://campeoesleagueoflegends.sa-east-1.elasticbeanstalk.com/champions/{id}/ask",
};
...
async function main(){
  ...
  async function onChangeChampionSelected(id, imageUrl){
    ...
    //2. guardar id do personagem selecionado
  ...
  async function getRandomQuote(){
    const quotes= [
      ...
      "Tenho vidas a salvar, vai depressa com isso",
      "Vamo que vamo meu chapa",
      "Pergunte logo",
      "Você esta com dificuldade para perguntar? "
    ];
